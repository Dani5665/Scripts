...
$Action = New-ScheduledTaskAction -Execute 'C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe' -Argument '-WindowStyle Hidden -ExecutionPolicy Bypass -File "C:\Program Files\WireGuard\MainTaskScript.ps1"'
